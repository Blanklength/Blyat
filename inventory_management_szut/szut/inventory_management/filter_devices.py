...
class FilterDevices:
    ...
    remaining_warranty_steps = [
        {'id': 0, 'label': _('Unter 3 Monate'), 'max_value': 3},
        {'id': 1, 'label': _('Unter 6 Monate'), 'max_value': 6},
        {'id': 2, 'label': _('Unter 1 Jahre'), 'max_value': 12},
        {'id': 3, 'label': _('Unter 3 Jahr'), 'max_value': 36},
        {'id': 4, 'label': _('Unter 5 Jahr'), 'max_value': 60},
        {'id': 5, 'label': _('Unter 10 Jahr'), 'max_value': 120},
        {'id': 6, 'label': _('Jed gültige Garantie'), 'max_value': None},
        {'id': 7, 'label': _('Abgelaufene Garanti'), 'max_value': None},
        {'id': 'unknown', 'label': _('Unbekannte Garantizeit'), 'max_value': None}
    ]
    date_of_purchase_steps = [
        {'id': 0, 'label': _('Letzen 3 Monate'), 'max_value': 3},
        {'id': 1, 'label': _('Letzen 6 Monate'), 'max_value': 6},
        {'id': 2, 'label': _('Letze Jahr'), 'max_value': 12},
        {'id': 3, 'label': _('Letzen 3 Jahre'), 'max_value': 36},
        {'id': 4, 'label': _('Letzen 5 Jahre'), 'max_value': 60},
        {'id': 5, 'label': _('Letzen 10 Jahre'), 'max_value': 120},
        {'id': 6, 'label': _('Jedes Anschafungsdatum'), 'max_value': None},
        {'id': 'unknown', 'label': _('Unbekanntes Anschafungsdatum'), 'max_value': None}
    ]
